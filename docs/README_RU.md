...
> [!WARNING]
> Этот проект является экспериментальным и ещё не тестировался на физических устройствах. Используйте его на свой страх и риск и обязательно сохраните свой резервную копию исходного загрузочного образа.
