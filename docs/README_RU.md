...
> [!WARNING]
> Этот проект является экспериментальным и ещё не тестировался на телефоне. Используйте его на свой страх и риск и обязательно сохраните свой boot.img .
