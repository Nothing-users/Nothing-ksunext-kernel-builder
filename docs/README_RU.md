...
> [!WARNING]
> Этот проект является экспериментальным и ещё не тестировался на физических устройствах. Используйте его на свой страх и риск и обязательно сохраните резервную копию исходного загрузочного образа.
...
- Небольшие исправления совместимости для модифицированного ядра Nothing версии 6.1
